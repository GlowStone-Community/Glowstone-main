      ...
      <div className="container mx-auto w-[min(1100px,92%)]">
        <div className="flex items-center justify-center gap-3 mb-3">
          <div className="item-frame w-8 h-8 flex items-center justify-center">
            <Image src="/assets/svg/torch.svg" alt="torch" width={20} height={20} className="pixelated" />
          </div>
          <div className="item-frame w-8 h-8 flex items-center justify-center">
            <Image src="/assets/svg/diamond.svg" alt="diamond" width={20} height={20} className="pixelated" />
          </div>
          <div className="item-frame w-8 h-8 flex items-center justify-center">
            <Image src="/assets/svg/creeper.svg" alt="creeper" width={20} height={20} className="pixelated" />
          </div>
        </div>
